...
def _mandate_evidence(snapshot, *, observed_at: datetime
    ...
    values = (
        ...
        ("mandate.purposes", tuple(mandate.purposes)),
...
def resolve_payment_authority(req, *, resolved_at: datetime
    ...
    if req.purpose not in index["mandate.purposes"].observed_value:
        raise AuthorityResolutionError("purpose outside authoritative mandate scope")
